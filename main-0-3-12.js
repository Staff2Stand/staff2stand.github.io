...
const stringReference = {
    violin: {
        ...
        gFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , low+'2' , '2' , hi+'2' , '3' , hi+'2' , '3' , '3' , hi+'3' , low+'4'],
        d: ['D' , '=D' , '^D' , '_E' , 'E' , '=E' , '^E' , '_F' , 'F' , '=F' , '^F' , '_G' , 'G' , '=G' , '^G' , '_A'],
        dFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , '1' , '2' , low+'2' , hi+'2' , low+'3' , '3' , '3' , hi+'3' , low+'4'],
        a: ['A' , '=A' , '^A' , '_B' , 'B' , '=B' , '^B' , '_c' , 'c' , '=c' , '^c' , '_d' , 'd' , '=d' , '^d' , '_e'],
        aFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , '1' , '2' , low+'2' , hi+'2' , low+'3' , '3' , '3' , hi+'3' , low+'4'],
        e: ['e' , '=e' , '^e' , '_f' , 'f' , '=f' , '^f' , '_g' , 'g' , '=g' , '^g' , '_a' , 'a' , '=a' , '^a' , '_b' , 'b' , '=b' , '^b'],
        eFingers: ['0' , '0' , low+'1' , '0' , low+'1' , '1' , '1' , '2' , low+'2' , hi+'2' , low+'3' , '3' , '3' , hi+'3' , low+'4' , '4' , '4' , 'x4']
    },
    viola: {
        c: ['C,' , '=C,' , '^C,' , '_D,' , 'D,' , '=D,' , '^D,' , '_E,' , 'E,' , '=E,' , '^E,' , '_F,', 'F,' , '=F,' , '^F,' , '_G,'],
        cFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , low+'2' , '2' , hi+'2' , '3' , low+'3' , '3' , '3' , hi+'3' , low+'4'],
        g: ['G,' , '=G,' , '^G,' , '_A,' , 'A,' , '=A,' , '^A,' , '_B,' , 'B,' , '=B,' , '^B,' , '_C' , 'C' , '=C' , '^C' , '_D'],
        gFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , low+'2' , '2' , hi+'2' , '3' , hi+'2' , '3' , '3' , hi+'3' , low+'4'],
        d: ['D' , '=D' , '^D' , '_E' , 'E' , '=E' , '^E' , '_F' , 'F' , '=F' , '^F' , '_G' , 'G' , '=G' , '^G' , '_A'],
        dFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , '1' , '2' , low+'2' , hi+'2' , low+'3' , '3' , '3' , hi+'3' , low+'4'],
        a: ['A' , '=A' , '^A' , '_B' , 'B' , '=B' , '^B' , '_c' , 'c' , '=c' , '^c' , '_d' , 'd' , '=d' , '^d' , '_e' , 'e' , '=e' , '^e'],
        aFingers: ['0' , '0' , low+'1' , low+'1' , '1' , '1' , hi+'1' , '1' , '2' , low+'2' , hi+'2' , low+'3' , '3' , '3' , hi+'3' , low+'4' , '4' , '4' , 'x4']
    },
    cello: {
        c: ['C,' , '=C,' , '^C,' , '_D,' , 'D,' , '=D,' , '^D,' , '_E,' , 'E,' , '=E,' , '^E,' , '_F,', 'F,' , '=F,' , '^F,' , '_G,'],
